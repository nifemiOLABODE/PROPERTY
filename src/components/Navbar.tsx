...
export const Navbar: React.FC<NavbarProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <>
      {/* Fixed Navbar — always visible, always at the very top */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-flow-cream shadow-subtle border-b border-flow-border/80 py-3">
      ...
      {/* Spacer — pushes page content below the fixed navbar so nothing is hidden behind it */}
